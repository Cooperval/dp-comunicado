/* =======================================================================================
 * API de Fluxo de Caixa — Lançamentos futuros + Pendências
 * - Helpers de validação/conversão
 * - Wrapper de fetch com tratamento de erro (HttpError)
 * - Endpoints de: criar/atualizar/excluir lançamentos
 * - Endpoints de: criar/atualizar/upsert pendências
 * ---------------------------------------------------------------------------------------
 * Dica: defina NEXT_PUBLIC_API_URL (ex.: http://localhost:8850) para usar base absoluta.
 * Caso contrário, as rotas serão relativas ao app (útil se você tem um proxy no Next).
 * =======================================================================================
 */
 ...
 * ========================================= */
export async function enviarLancamento(form: LancForm) {
  // validações mínimas
 ...
 * ========================================= */
export async function deletarLancamento(id: string | number) {
  return fetchJSON(
 ...
 * ========================================= */
export async function deletarContaSaldo(form: {
  cod_banco: number;
  cod_agencia: number;
  cod_contabancaria: number;
  digito: string | number | null;
