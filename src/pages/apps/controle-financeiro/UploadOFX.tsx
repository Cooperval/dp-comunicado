...
const UploadOFX = () => {
  ...
  const endIndex = Math.min(startIndex + itemsPerPage, totalUploads);
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button onClick={loadUploads} disabled={loadingUploads}>
              {loadingUploads ? (
                <>
          ...
          <CardContent>
            ...
            <div className="text-center py-8 text-muted-foreground">
              Clique em "Buscar OFX's" para carregar os arquivos enviados
            </div>
            ) : (
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="text-sm text-muted-foreground text-center">
                    {totalUploads} iten(s) - Mostrando {startIndex + 1}-{endIndex}
                  </div>
                ...
                <div className="text-sm text-muted-foreground text-center">
                  Mostrando {startIndex + 1}-{endIndex} de {totalUploads} itens
                </div>
