...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      budget_seasonal_factors: {
        Row: {
          calculated_from_year: number
          calculated_to_year: number
          commitment_group_id: string | null
          commitment_id: string | null
          commitment_type_id: string | null
          company_id: string
      ...
      integrated_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "integrated_transactions_commitment_group_id_fkey"
            columns: ["commitment_group_id"]
            isOneToOne: false
            referencedRelation: "commitment_groups"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "integrated_transactions_commitment_id_fkey"
            columns: ["commitment_id"]
            isOneToOne: false
            referencedRelation: "commitments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "integrated_transactions_commitment_type_id_fkey"
            columns: ["commitment_type_id"]
            isOneToOne: false
            referencedRelation: "commitment_types"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "integrated_transactions_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      cleanup_orphaned_banks: { Args: never; Returns: undefined }
      has_role: {
        Args: {
      ...
      user_has_demo_access: { Args: never; Returns: boolean }
    }
    Enums: {
      app_role: "admin" | "operador" | "gestor" | "representante"
