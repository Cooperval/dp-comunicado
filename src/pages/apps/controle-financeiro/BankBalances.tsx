  ...
  const fetchAvailableMonths = async () => {
    try {
      ...
      futureMonths?.forEach(f => {
        const date = parseISO(f.due_date);
        const monthKey = format(date, 'yyyy-MM');
        months.add(monthKey);
      });
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-muted-foreground">R$ 0,00</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8 text-center">
              {loading ? (
                <div className="flex flex-col items-center justify-center py-8">
                  ...
                  <p className="text-lg font-medium">Carregando saldos bancários...</p>
                </div>
              ) : (
                <>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Clique em 'Buscar' para carregar os saldos ou importe um arquivo OFX para começar
                  </p>
                    ...
                    <div className="flex items-center gap-2 text-sm text-muted-foreground mt-3">
                      ...
                      <span>
                        ...
                        {account.last_transaction_date 
                          ? format(parseISO(account.last_transaction_date), 'dd/MM/yyyy', { locale: ptBR })
                          : 'Nenhuma transação'
                        }
                      </span>
                    </div>
