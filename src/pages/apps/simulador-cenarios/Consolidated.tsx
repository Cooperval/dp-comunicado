...
export default function Consolidated() {
  ...
  const exportToExcel = () => {
    ...
    const exportData = [
      ...
      ['  Rendimento EAC (L/t)', ...savedScenarios.map(s => (s.data.premissaCanaRendimentoEAC || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['MILHO', ...Array(savedScenarios.length + 1).fill('')],
      ['  Rendimento Total Convertido (L/ton)', ...savedScenarios.map(s => (s.data.premissaMilhoRendimentoConvertido || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  Rendimento DDG (kg/ton)', ...savedScenarios.map(s => (s.data.premissaMilhoRendimentoDDG || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  Rendimento WDG (kg/ton)', ...savedScenarios.map(s => (s.data.premissaMilhoRendimentoWDG || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['', ...Array(savedScenarios.length + 1).fill('')], // Linha em branco
      ...
      ['  Matéria-prima (R$/ton)', ...savedScenarios.map(s => (s.data.custoCanaUnitarioMateriaPrima || 0).toLocaleString('pt-BR')), '-'],
      ['  CCT (R$/ton)', ...savedScenarios.map(s => (s.data.custoCanaUnitarioCCT || 0).toLocaleString('pt-BR')), '-'],
      ['  Indústria (R$/ton)', ...savedScenarios.map(s => (s.data.custoCanaUnitarioIndustria || 0).toLocaleString('pt-BR')), '-'],
      ['  Dispêndios (R$/ton)', ...savedScenarios.map(s => (s.data.custoCanaUnitarioDispendios || 0).toLocaleString('pt-BR')), '-'],
      ['  Total Cana (R$/ton)', ...savedScenarios.map(s => (s.data.custoCanaUnitarioTotal || 0).toLocaleString('pt-BR')), '-'],
      ['MILHO (R$/ton milho)', ...Array(savedScenarios.length + 1).fill('')],
      ['  Matéria-prima (R$/ton)', ...savedScenarios.map(s => (s.data.custoMilhoUnitarioMateriaPrima || 0).toLocaleString('pt-BR')), '-'],
      ['  Indústria (R$/ton)', ...savedScenarios.map(s => (s.data.custoMilhoUnitarioIndustria || 0).toLocaleString('pt-BR')), '-'],
      ['  Biomassa (R$/ton)', ...savedScenarios.map(s => (s.data.custoMilhoUnitarioBiomassa || 0).toLocaleString('pt-BR')), '-'],
      ['  Total Milho (R$/ton)', ...savedScenarios.map(s => (s.data.custoMilhoUnitarioTotal || 0).toLocaleString('pt-BR')), '-'],
      ['', ...Array(savedScenarios.length + 1).fill('')], // Linha em branco
      ['CUSTOS DE PRODUTOS VENDIDOS', ...Array(savedScenarios.length + 1).fill('')],
      ['CANA', ...Array(savedScenarios.length + 1).fill('')],
      ['  Açúcar VHP (R$/ton)', ...savedScenarios.map(s => (s.data.cpvAcucarVHP || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  Etanol Hidratado - EHC (R$/m³)', ...savedScenarios.map(s => (s.data.cpvEHC || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  Etanol Anidro - EAC (R$/m³)', ...savedScenarios.map(s => (s.data.cpvEAC || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['MILHO', ...Array(savedScenarios.length + 1).fill('')],
      ['  Etanol Hidratado - EHM (R$/m³)', ...savedScenarios.map(s => (s.data.cpvEHM || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  Etanol Anidro - EAM (R$/m³)', ...savedScenarios.map(s => (s.data.cpvEAM || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  DDG (R$/ton)', ...savedScenarios.map(s => (s.data.cpvDDG || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['  WDG (R$/ton)', ...savedScenarios.map(s => (s.data.cpvWDG || 0).toLocaleString('pt-BR', { minimumFractionDigits: 2 })), '-'],
      ['', ...Array(savedScenarios.length + 1).fill('')], // Linha em branco
      ...
      ['    Açúcar VHP (R$)', ...savedScenarios.map(s => (s.data.cpvTotalAcucarVHP || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalAcucarVHP || 0)],
      ['    Etanol Hidratado (R$)', ...savedScenarios.map(s => (s.data.cpvTotalEHC || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalEHC || 0)],
      ['    Etanol Anidro (R$)', ...savedScenarios.map(s => (s.data.cpvTotalEAC || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalEAC || 0)],
      ...
      ['    Etanol Hidratado (R$)', ...savedScenarios.map(s => (s.data.cpvTotalEHM || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalEHM || 0)],
      ['    Etanol Anidro (R$)', ...savedScenarios.map(s => (s.data.cpvTotalEAM || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalEAM || 0)],
      ['    DDG (R$)', ...savedScenarios.map(s => (s.data.cpvTotalDDG || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalDDG || 0)],
      ['    WDG (R$)', ...savedScenarios.map(s => (s.data.cpvTotalWDG || 0).toLocaleString('pt-BR')), calculateTotal(s => s.data.cpvTotalWDG || 0)],
