...
export function useMovimentacao() {
  ...
  const fetchData = useCallback(async (params = {}) => {
    const { dataInicio, dataFim, codGrupoEmpresa,
      codEmpresa,
      codFilial, codFornecedor } = params || {};
    ...
    try {
      ...
      if (codFornecedor) qs.append("codFornecedor", String(codFornecedor));
      
      const url =
        `${urlApi}/fluxo-caixa/pendencias` +
